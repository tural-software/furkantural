...
/// <summary>Kayıt defteri erişimi. Bilerek IRepository&lt;Log&gt; değildir: kayıt eklenir ve okunur, güncelleme veya silme sözleşmeye hiç girmez. Adında Admin geçen metotlar da diğer repo'lardan ayrılır — burada silinmiş ve pasif satırları elerler, oysa <see cref="IReadRepository{T}"/> tarafındaki karşılıkları filtresizdir.<para>Süzgeçlerde level birebir eşleşir, project ile message içinde-geçen araması yapar. dateTo günün tamamını kapsar (bir gün eklenip küçüktür ile karşılaştırılır), dolayısıyla saat bilgisi taşıyan bir değer beklenenden bir gün fazlasını getirir. Sıralama Id'ye değil kaydın kendi Date alanına göre azalandır ve yüklem verilip verilmemesi bunu değiştirmez.</para></summary>
