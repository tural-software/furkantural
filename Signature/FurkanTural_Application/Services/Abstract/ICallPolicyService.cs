...
/// <summary>
/// Görüntülü arama kalite politikası. Tabloda tek bir satır tutulur ve herkese uygulanır;
/// GetEffectiveForUserAsync'in userId parametresi ileride kullanıcı bazlı politika için açılmış
/// dikiştir, bugün sonucu etkilemez. Satır bulunamazsa hata değil koda gömülü varsayılan politika
/// döner, yani çağıran her zaman kullanılabilir bir değer alır. UpdateAsync gelen değerleri sabit
/// alt ve üst sınırlara kırpar.
/// </summary>
