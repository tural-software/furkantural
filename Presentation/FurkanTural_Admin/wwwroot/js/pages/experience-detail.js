/**
 * Experience Detail Modal — config + page binding
 *
...
(function () {
                ...
                fields: [
                    {
                        label: 'Pozisyon',
                        icon: 'field-text',
                        value: function (r) { return r.position || '—'; }
                    },
                    {
                        label: 'Şirket Adı',
                        icon: 'field-text',
                        value: function (r) { return r.companyName || '—'; }
                    },
                    {
    ...
    function buildCreateConfig(onSuccess) {
        return {
            ...
            description: 'Yeni bir deneyim kaydı oluşturun.',
            submitUrl: '/Experience/Create',
            submitLabel: 'Ekle',
            fields: EXPERIENCE_FORM_FIELDS,
            onSuccess: onSuccess
        };
    }
    ...
    function buildEditConfig(id, onSuccess) {
        return {
            ...
            description: 'Mevcut deneyim kaydını güncelleyin.',
            submitUrl: '/Experience/Update/' + id,
    ...
    function reloadTable() {
        var meta = window.__experienceMeta || {};
        ...
        fetch('/Experience/TablePartial?' + params.toString(), {
        ...
        .then(function (html) {
            var section = document.getElementById('experience-table-section');
            if (!section) return;
    ...
    function bindAll() {
        ...
        document.querySelectorAll('.ft-view-btn').forEach(function (btn) {
            btn.addEventListener('click', function () {
                ...
                DetailModal.open(ExperienceDetailConfig, record, function (key) {
                    if (key === 'edit') {
                        DetailModal.close();
        ...
        document.querySelectorAll('.row-actions form').forEach(function (form) {
            form.addEventListener('submit', function (e) {
                ...
                var recordName = record ? (record.position || record.companyName || 'ID: ' + record.id) : '—';
