...
/// <summary>Bir API çağrısının sonucu: başarı + gerçek durum kodu + (varsa) API'nin kullanıcıya dönük hata mesajı. Controller'lar bunu kullanarak gerçek durumu yüzeye çıkarır (401→login, 4xx/5xx → gerçek mesaj) — eskiden her başarısızlık generic 500'e maskeleniyordu.</summary>
