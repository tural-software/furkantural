namespace FurkanTural_Admin.Models.BlogImage;

public sealed class BlogImageIndexViewModel
{
    public IReadOnlyList<BlogImageAdminDto> Rows { get; set; } = [];
    ...
    public int?    BlogIdFilter   { get; set; }
