...
/// <summary>Oturum çerezini ve sahtecilik jetonunu şifreleyen anahtarların nerede saklanacağını çözer.<para>Varsayılan davranışta, IIS altında uygulama havuzunun profili yüklü değilse anahtarlar yalnızca bellekte tutulur; her geri dönüşümde ve her yayında sıfırlanırlar. Sonuç açık oturumların toptan düşmesi ve sahtecilik jetonu hatalarıdır. Bu sitede oturum yoktur ama yorum, iletişim ve bülten formlarının sahtecilik jetonu her yeniden başlatmada geçersizleşir.</para><para>Uygulama paylaşımlı bir barındırmada çalışır ve havuz kimliği çoğu zaman yalnızca sitenin kendi klasör ağacına erişebilir; makine geneli yollar kapalı olabilir. Bu yüzden tek bir yola bel bağlanmaz: adaylar sırayla denenir ve gerçek bir yazma denemesinden geçen ilki kullanılır.</para><para>Hiçbiri yazılamıyorsa uygulama durdurulmaz. Durmak, çözülmeye çalışılan sorundan daha kötüsünü üretirdi: oturumların düşmesi yerine sitenin tümüyle kapanması. Bunun yerine belleğe düşülür ve durum hata seviyesinde kaydedilir.</para><para>Anahtarları veri tabanında tutmak daha dayanıklı olurdu ama mimari buna izin vermez; sunum projeleri veri tabanına dokunmaz.</para><para>Aynı mantığın kopyaları Admin, Chat, Blog ve Portfolio projelerinin <c>PersistentDataProtectionExtensions.cs</c> dosyalarındadır. Biri değişirse diğerleri de değişmelidir.</para></summary>
