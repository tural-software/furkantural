...
/// <summary>Bülten akışının tek gövde tipi. Üç alan da opsiyoneldir çünkü her uç yalnızca kendi ihtiyacını okur: abonelik <c>Email</c> ile <c>TurnstileToken</c>'ı, onay ve çıkış yalnızca <c>Token</c>'ı.<para><c>Token</c> bir kimlik bilgisidir ve yalnızca adrese giden postanın bağlantısında bulunur. Çıkış ucu adres kabul etmez: adres tek başına yeterli olsaydı herhangi biri başkasının aboneliğini iptal edebilirdi.</para></summary>
