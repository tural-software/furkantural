...
public class LogController(ILogService logService, IClock clock) : BaseApiController
{
    ...
    /// <summary>
    /// Admin panelinin (AdminOnly JWT) sunucu-tarafı hata/uyarı logunu sistem log tablosuna yazar.
    /// Admin'in app-token'ı yoktur; ClientLog (AppClient) yerine bu uç nokta kullanılır.
    /// </summary>
    [HttpPost]
