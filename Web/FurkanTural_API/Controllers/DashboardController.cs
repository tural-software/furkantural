...
public class DashboardController(IAdminDashboardService dashboardService) : JwtBaseController
{
    ...
    /// <summary>Yönetim panelinin açılış verisi tek yanıtta: yirmi dört varlığın özeti, okunmamış iletişim, bekleyen şikayet ve onay bekleyen yorum sayısı, pencere içinde görülen aktif kullanıcı ve iki haftalık sayaç. windowDays 1-90 gün (varsayılan 7); today verilmezse sunucunun UTC günü</summary>
