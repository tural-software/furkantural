...
public class UnitOfWork(FurkanTuralDbContext context) : IUnitOfWork
{
    ...
    public IRepository<Tag> Tags => GetRepository<Tag>();
    ...
    public IRepository<SubscriberVerification> SubscriberVerifications => GetRepository<SubscriberVerification>();
    public IRepository<NewsletterIssue> NewsletterIssues => GetRepository<NewsletterIssue>();
    public IRepository<NewsletterDelivery> NewsletterDeliveries => GetRepository<NewsletterDelivery>();
